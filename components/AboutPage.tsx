            ...
            content: (
                <div style={{ display: "flex", flexDirection: "column", gap: sectionGap }}>
                    ...
                    <div>
                        ...
                        <ol style={{ ...styles.list, gap: listGap }}>
                            <li>Each round, <strong>0.3 BEAN</strong> is added to the Beanpot from the round&apos;s token emission.</li>
                    ...
                    <div>
                        ...
                        <div style={isMobile ? styles.infoBoxMobile : styles.infoBox}>
                            <p style={{ margin: 0 }}>At 0.3 BEAN per round with rounds every 60 seconds, the Beanpot grows by roughly <strong>432 BEAN per day</strong> (1,440 rounds × 0.3 BEAN). On average, it triggers once every ~777 rounds (~13 hours), creating an expected pool of <strong>~234 BEAN</strong> at the time of trigger.</p>
            ...
            content: (
                <div style={{ display: "flex", flexDirection: "column", gap: sectionGap }}>
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0 }}>In split rounds, the 1 BEAN is divided among all miners on the winning block proportional to their deployment, rather than going to one person. Split rounds are indicated with a &quot;Split&quot; badge in the mining history on the Global page.</p>
                    </div>
                    <div>
                        <h3 style={isMobile ? styles.h3Mobile : styles.h3}>Example</h3>
                        <div style={isMobile ? styles.infoBoxMobile : styles.infoBox}>
...
<tr><td style={isMobile ? styles.tableLabelMobile : styles.tableLabel}>Contract</td><td style={isMobile ? styles.tableValueMobile : styles.tableValue}><a href="https://basescan.org/token/0x5c72992b83E74c4D5200A8E8920fB946214a5A5D" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', wordBreak: 'break-all' }}>0x5c72...A5A5D</a></td></tr>                            </tbody>
                    ...
                    <div>
                        ...
                        <table style={styles.table}>
                            <tbody>
                                <tr><td style={isMobile ? styles.tableLabelMobile : styles.tableLabel}>BEAN Reward (winner)</td><td style={isMobile ? styles.tableValueMobile : styles.tableValue}>1 BEAN</td></tr>
                                <tr><td style={isMobile ? styles.tableLabelMobile : styles.tableLabel}>Beanpot contribution</td><td style={isMobile ? styles.tableValueMobile : styles.tableValue}>0.3 BEAN</td></tr>
                            </tbody>
                        </table>
                    </div>
                    <div>
            ...
            content: (
                <div style={{ display: "flex", flexDirection: "column", gap: sectionGap }}>
                    ...
                    <div>
                        ...
                        <table style={styles.table}>
                            <tbody>
                                <tr><td style={isMobile ? styles.tableLabelMobile : styles.tableLabel}>Source</td><td style={isMobile ? styles.tableValueMobile : styles.tableValue}>1% admin fee + 10% vault fee</td></tr>
            ...
            content: (
                <div style={{ display: "flex", flexDirection: "column", gap: sectionGap }}>
                    ...
                    <div style={styles.faqItem}>
                        ...
                        <p style={{ margin: "12px 0 0 0" }}>A growing BEAN jackpot funded by 0.3 BEAN per round. Each round has a 1-in-777 chance of triggering it. On average it triggers roughly every 13 hours, but the timing is random — it could trigger much sooner or accumulate much larger.</p>
                    </div>
                    <div style={styles.faqItem}>

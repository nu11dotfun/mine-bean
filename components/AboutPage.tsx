                    ...
                    <div>
                        ...
                        <table style={styles.table}>
                            <tbody>
                                ...
                                <tr><td style={isMobile ? styles.tableLabelMobile : styles.tableLabel}>Emission</td><td style={isMobile ? styles.tableValueMobile : styles.tableValue}>1.1 BEAN per round</td></tr>
<tr><td style={isMobile ? styles.tableLabelMobile : styles.tableLabel}>Contract</td><td style={isMobile ? styles.tableValueMobile : styles.tableValue}><a href="https://basescan.org/token/0x5c72992b83E74c4D5200A8E8920fB946214a5A5D" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', wordBreak: 'break-all' }}>0x5c72...A5A5D</a></td></tr>                            </tbody>
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0 }}>Each round mints 1.1 BEAN, distributed as follows:</p>
                        <table style={styles.table}>
                            <tbody>
                                ...
                                <tr><td style={isMobile ? styles.tableLabelMobile : styles.tableLabel}>Beanpot contribution</td><td style={isMobile ? styles.tableValueMobile : styles.tableValue}>0.1 BEAN</td></tr>
                            </tbody>
                        </table>
                    </div>
                    <div>

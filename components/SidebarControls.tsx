...
const handleSelectClick = () => {
    ...
    return (
        <div style={styles.container}>
            <div style={styles.statsGrid}>
                ...
                >
                    <div style={styles.statValue}>
                        <span style={{...styles.timerValue, color: timer <= 5 && timer > 0 ? "#FF4444" : "#fff"}}>{timer === 0 ? <span style={{fontSize: "75%", opacity: 1}}>Waiting...</span> : formatTime(timer)}</span>
                    </div>
                    <div style={styles.statLabel}>
                ...
                {!autoMinerActive && (
                    ...
                    >
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={heatmapEnabled ? "#4a9fff" : "#888"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    className="strategy-btn"
        ...
        onClick={(e) => { handleAllClick(); (e.currentTarget as HTMLButtonElement).blur() }}
    >
        All
    </button>
    <button
    className="strategy-btn"
        style={{
            ...styles.allBtn,
            ...(blockSelection === "random" ? styles.allBtnActive : {}),
        }}
        onClick={(e) => { handleRandomClick(); (e.currentTarget as HTMLButtonElement).blur() }}
    >
        Random
    </button>
    <button
    className="strategy-btn"
        style={{
            ...styles.allBtn,
            ...(blockSelection === "select" ? styles.allBtnActive : {}),
        }}
        onClick={(e) => { handleSelectClick(); (e.currentTarget as HTMLButtonElement).blur() }}
    >
        Select
    </button>
</div>

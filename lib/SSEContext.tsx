...
const USER_EVENTS = ['autoMineExecuted', 'configDeactivated', 'stopped', 'claimedBNB', 'claimedBEAN', 'checkpointed', 'stakeDeposited', 'stakeWithdrawn', 'yieldClaimed', 'yieldCompounded', 'profileUpdated']
